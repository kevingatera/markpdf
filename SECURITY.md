...
- `go test ./...`, `go vet ./...`, and `go build ./cmd/markpdf` pass.
- A representative PDF renders without clipped text, broken diagrams, or header/footer overlap.
- Embedded third-party asset versions and licenses are documented.
